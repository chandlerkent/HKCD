...
Environment.prototype.enterClassDeclaration = function(aClass) {
    this.currentClass = aClass;
};

Environment.prototype.exitClassDeclaration = function() {
...
Environment.prototype.isPrimitiveType = function(aType) {
    return "boolean" === aType || "int" === aType;
}
...
Environment.prototype.supersReturnType = function(aClass, aMethod) {
    return this.classOrSupersReturnType(this.getClass(aClass).superClass, aMethod);
};

Environment.prototype.classOrSupersReturnType = function(aClass, aMethod) {
    if(this.classHasMethod(aClass, aMethod))
        return this.classes[aClass].methods[aMethod].returnType;
...
Environment.prototype.supersMethodParameterTypes = function(aClass, aMethod) {

    if(!this.getClass(aClass).superClass) {
        return [];
    }
    
    return this.classOrSupersMethodParameterTypes(this.getClass(aClass).superClass, aMethod);
};

Environment.prototype.classOrSupersMethodParameterTypes = function(aClass, aMethod) {
    if(this.classHasMethod(aClass, aMethod))
        return this.getClass(aClass).methods[aMethod].getParameterTypes();
...
Environment.prototype.addMethodToClass = function(aClass, aMethod, methodMap) {
    if (this.hasClass(aClass)) {
        if (!this.classHasMethod(aClass, aMethod)) {
            this.getClass(aClass).methods[aMethod] = methodMap;
        }
    } else {
