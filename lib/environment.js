...
Environment.prototype.classOrSupersMethodType = function(aClass, aMethod) {
    if(this.classHasMethod(aClass, aMethod))
        return this.classes[aClass].methods[aMethod].methodType;
...
Environment.prototype.classOrSupersMethodParameterTypes = function(aClass, aMethod) {
    if(this.classHasMethod(aClass, aMethod))
        return this.getClass(aClass).methods[aMethod].parameterTypes;
...
Environment.prototype.addMethodToClass = function(aClass, aMethod, parameterTypes, methodType) {
    if (this.hasClass(aClass)) {
        if (!this.classHasMethod(aClass, aMethod)) {
            this.getClass(aClass).methods[aMethod] = buildMethodMap(parameterTypes, methodType);
        }
    } else {
...
buildMethodMap = function(parameterTypes, methodType) {
    var obj = {};
