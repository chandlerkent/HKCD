...
var FieldDecl = require(File.absolute("lib/FieldDecl"));
...
var MethodDecl = require((File.absolute("lib/MethodDecl"));
...
function main()
{
    ...
    if (File.isDirectory(options.args[0])) {
        ...
        var driver = new Driver([FieldDecl, FieldShadow, MethodOverload, MethodOverride, ParameterTypes, MethodDecl]);
