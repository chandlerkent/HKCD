...
CodeEmitter.prototype = {
    ...
    emitClass: function(className) {
        ...
        this.emitClassInitializer();
    },
    
    emitClassInitializer: function() {
        this.addCode(".method public <init>()V");
    ...
    emitInvokeVirtual: function(className, methodName, paramTypes, returnType) {
        this.addCode("invokevirtual " + className + "/" + methodName + this.buildMethodTypeDescriptor(paramTypes, returnType));
    },
    
    emitInvokeSpecial: function(className, methodName, paramTypes, returnType) {
        this.addCode("invokespecial " + className + "/" + methodName + this.buildMethodTypeDescriptor(paramTypes, returnType));
    },
};