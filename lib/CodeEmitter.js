...
CodeEmitter.prototype = {
    ...
    emitIfGreaterThan: function() {
        this.addCode(["if_icmpgt", this.getNextLabel()].join(" "));
    },
    
    emitIfLessThanEqual: function() {
        this.addCode(["if_icmple", this.getNextLabel()].join(" "));
    },
    
    emitIfGreaterThanEqual: function() {
        this.addCode(["if_icmpge", this.getNextLabel()].join(" "));
    },
