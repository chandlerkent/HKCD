...
exports.typeCheck = function(ast) {
    ...
    var driver = new Driver([InitialAssignment, Assignment, PrintLine, IfWhile, MethodDecl, ClassDecl, ParameterTypes, ParameterDecl, MethodOverload, FieldDecl, FieldShadow, MethodOverride]);
