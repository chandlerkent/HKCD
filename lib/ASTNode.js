...
var ASTNode = exports.ASTNode = function(name, children, properties) {
    ...
    if (exprIndex > 0) {
        ...
        this.checkType = ExpressionChecks[functionName] || function() { print("NOT YET IMPLEMENTED CHECKTYPE FOR " + this.name); };
...
ASTNode.prototype.isReturnExpression = function() {
    return this.name === "ReturnExpression";
};

ASTNode.prototype.isCallExpression = function() {
    return this.name === "CallExpression";
};
...
ASTNode.prototype.getClosureName = function() {
...
ASTNode.prototype.walk = function(fn, env) {
    ...
    if (this.isInitialAssignment() || this.isAssignment()) {
        if (this.getValue().name == "ClosureExpression") {
            this.getValue().children.forEach(function (child) {
                env = child.walk(fn, env);
            });
        }
    }
