...
var ASTNode = exports.ASTNode = function(name, children, properties) {
    ...
    for (var property in properties) {
        ...
        // var getterName = "get" + property[0].toUpperCase() + property.substring(1);
        // print(getterName);
        // this[getterName] = function() { return this[property]; };
    }
};
...
ASTNode.prototype.walk = function(fn, env) {
    env = env || (new (require("./Environment").Environment)());
    
    fn(this, env);
    
    if(this.isClassDeclaration())
        env.currentClass = env.getClass(this.getClassName());
        
    if(this.isMethodDeclaration())
        env.currentMethod = env.currentClass.getMethod(this.getMethodName());
...
exports.ASTNode.expressionCheck = require("./ExpressionChecks");
exports.ASTNode.expressionType = require("./ExpressionTypes");