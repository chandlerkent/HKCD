...
exports.Return = function(aType, env) {
    ...
    var match = false;
    var theExpression = this.expression;
    
    if(!env.hasClass(this.expression.getExpressionType(env))) {
...
exports.Call = function(aType, env) {
    ...
    return simpleCheck(aType, actualType, "The return type of the method " + methodCallName + " was expected to be " + aType + " but is of type " + actualType, this.getLineNumber(), env);
};
